...
from .test_mdl_budget import *
from .test_mdl_club import *
from .test_mdl_division import *
from .test_mdl_event import *
from .test_mdl_eventsignin import *
from .test_mdl_joinrequest import *
...
from .test_view_club_search import *
from .test_view_club_view import *
